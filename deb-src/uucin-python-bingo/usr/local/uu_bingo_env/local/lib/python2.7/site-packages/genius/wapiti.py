...
_wapiti = ctypes.CDLL(os.path.abspath(os.path.join(os.path.join(here,'../'),'libwapiti.so')))
...
_wapiti.api_label_seq.restype = ctypes.c_char_p
...
class Model:
    ...
    def label_sequence(self, lines):
        ...
        """
        labeled = unicode(_wapiti.api_label_seq(self._model, lines),"utf-8")
        return labeled
