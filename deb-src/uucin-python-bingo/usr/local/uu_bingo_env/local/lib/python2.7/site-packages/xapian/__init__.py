...
def remote_open_writable(*args):
  """
    ...
    &program, const std::string &args, useconds_t timeout=0)
...
_MSetIterator.at_end = new_instancemethod(_xapian._MSetIterator_at_end,None,_MSetIterator)
...
_ESetIterator.at_end = new_instancemethod(_xapian._ESetIterator_at_end,None,_ESetIterator)
...
class Enquire(object):
    ...
    def set_sort_by_relevance_then_value(self, *args):
        ...
        reverse:  If true, reverses the sort order of sort_key. 
        """
...
class LatLongDistancePostingSource(ValuePostingSource):
    ...
    def __init__(self, *args): 
        ...
        db_:  The database to read values from.
